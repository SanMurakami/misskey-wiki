...
![aws_vpc_name_2021-09-19_07-13-29.png](/ja_jp/wiki_guide/aws/aws_vpc_name_2021-09-19_07-13-29.png)
`Name`の欄にある`-📝`をクリックすると名を与へ、VPCを「†ネームド†」級にすることができる。
![aws_vpc_named_2021-01-10_23-17-16.png](/ja_jp/wiki_guide/aws/aws_vpc_named_2021-01-10_23-17-16.png)
おつかれさま。🎉
次回はサブネットの編集をするよ！
## サブネットの編集
