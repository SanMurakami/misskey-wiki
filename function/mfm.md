...
### ブレ（ツイッチ）
テキストを`[twitch`と`]`で囲うと、激しい動きの『ブレ』アニメーションを加えることができる。 ~~（これめっちゃ荒ぶってるけど大丈夫？ｗｗ）~~
🕴🕴🕴
```
[twitch 🕴🕴🕴🕴🕴🕴🕴🕴🕴🕴🕴🕴]
```
> 【『ブレ（ツイッチ）』と『ぶるぶる（シェイク）』の違い】
> 『ブレ』は地震のように全てのテキストが等しく動くのに対し、『ぶるぶる』は『びよんびよん』のように、中心を起点として端っこが最も移動が多く、真ん中が最も移動距離が少ないような動きとなっている。
{.is-info}
